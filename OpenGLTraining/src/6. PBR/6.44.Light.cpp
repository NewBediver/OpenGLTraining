...
int main()
{
    ...
    // -------------------------
    Shader shader("Shaders/6.PBR/44.Light/6.44.Light.vs", "Shaders/6.PBR/44.Light/6.44.TexturedLight.fs");
    ...
    // build and compile shaders
    // -------------------------
    /*Shader shader("Shaders/6.PBR/44.Light/6.44.Light.vs", "Shaders/6.PBR/44.Light/6.44.Light.fs");
    shader.Use();
