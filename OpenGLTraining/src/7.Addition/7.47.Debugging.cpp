...
int main()
{
    ...
    // -------------------------
    Shader shader("Shaders/7.Addition/47.Debugging/7.47.Debugging.vs", "Shaders/7.Addition/47.Debugging/7.47.Debugging.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glBindTexture(GL_TEXTURE_2D, 2); // error line
