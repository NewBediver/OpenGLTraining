...
int main()
{
    ...
    // -------------------------
    Shader simpleDepthShader("Shaders/5.AdvancedLighting/36.PointShadows/5.36.PointShadowsDepth.vs", "Shaders/5.AdvancedLighting/36.PointShadows/5.36.PointShadowsDepth.fs", "Shaders/5.AdvancedLighting/36.PointShadows/5.36.PointShadowsDepth.gs");
    Shader simpleShadowShader("Shaders/5.AdvancedLighting/36.PointShadows/5.36.PointShadows.vs", "Shaders/5.AdvancedLighting/36.PointShadows/5.36.PointShadows.fs");
    ...
    simpleShadowShader.SetInt("depthMap", 1);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // 2. render scene as normal using the generated depth/shadow cubemap  
        // --------------------------------------------------------------
        ...
        //simpleShadowShader.SetInt("shadows", shadows); // enable/disable shadows by pressing 'SPACE'
        simpleShadowShader.SetFloat("far_plane", far);
