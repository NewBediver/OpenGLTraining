...
int main()
{
	...
	Shader lightingShader("Shaders/2.Lighting/15.LightingMap/2.15.LightingMap.vs", "Shaders/2.Lighting/15.LightingMap/2.15.LightingMap.fs");
	Shader lightningCubeShader("Shaders/2.Lighting/15.LightingMap/2.15.LightCube.vs", "Shaders/2.Lighting/15.LightingMap/2.15.LightCube.fs");
