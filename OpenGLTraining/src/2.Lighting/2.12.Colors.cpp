...
int main()
{
	...
	Shader lightingShader("Shaders/2.Lighting/12.Colors/2.12.Colors.vs", "Shaders/2.Lighting/12.Colors/2.12.Colors.fs");
	Shader lightningCubeShader("Shaders/2.Lighting/12.Colors/2.12.Colors.vs", "Shaders/2.Lighting/12.Colors/2.12.Light.fs");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		lightningCubeShader.SetMat4("u_Model", glm::mat4(1.0f));
