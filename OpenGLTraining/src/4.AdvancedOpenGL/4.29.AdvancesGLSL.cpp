...
int main()
{
	...
	Shader shader("Shaders/4.AdvancedOpenGL/29.AdvancedGLSL/4.29.AdvancedGLSL.vs", "Shaders/4.AdvancedOpenGL/29.AdvancedGLSL/4.29.FrontFacing.fs");
	...
	unsigned int faceTexture = LoadTexture("Resources/textures/awesomeface.png");
