...
int main()
{
	...
	// -------------------------
	Shader ourShader("Shaders/4.AdvancedOpenGL/30.GeometryShader/4.30.Exploding.vs", "Shaders/4.AdvancedOpenGL/30.GeometryShader/4.30.Exploding.fs", "Shaders/4.AdvancedOpenGL/30.GeometryShader/4.30.Exploding.gs");
