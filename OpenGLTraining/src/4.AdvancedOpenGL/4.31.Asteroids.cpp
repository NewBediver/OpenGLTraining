...
int main()
{
	...
	// -------------------------
	Shader asteroidShader("Shaders/4.AdvancedOpenGL/31.Instancing/4.31.Asteroids.vs", "Shaders/4.AdvancedOpenGL/31.Instancing/4.31.Asteroids.fs");
	Shader planetShader("Shaders/4.AdvancedOpenGL/31.Instancing/4.31.Planet.vs", "Shaders/4.AdvancedOpenGL/31.Instancing/4.31.Planet.fs");
